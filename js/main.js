// Main JavaScript para React Desde Cero

document.addEventListener('DOMContentLoaded', function() {
    console.log('☕ React Desde Cero - Sitio cargado correctamente');
    ...
    console.log('%c☕ ¡Bienvenido a React Desde Cero!', 'font-size: 20px; color: #61dafb; font-weight: bold;');
});
